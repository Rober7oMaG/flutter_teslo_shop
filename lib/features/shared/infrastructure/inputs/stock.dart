...
class Stock extends FormzInput<int, StockError> {
  ...
  String? get errorMessage {
    ...
    if (displayError == StockError.empty) return 'Stock field is required';
    if (displayError == StockError.value) return 'Stock must be greater or equal to 0';
    if (displayError == StockError.format) return 'Stock must be a number';
